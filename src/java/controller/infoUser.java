...
public class infoUser extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet infoUser</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet infoUser at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (id_raw != null && !id_raw.isEmpty()) {
            ...
            if (sessionId != null) {
                ...
                // Xử lý trường hợp không tìm thấy ID trong session
        ...
        if (account != null) {
            ...
            if (successMessage != null) {
                ...
                request.getSession().removeAttribute("Success"); // Xóa thông báo sau khi lấy để tránh hiển thị lại
            }
