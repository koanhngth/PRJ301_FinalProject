...
public class editBook extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        Book p = d.getBookId(id);
        request.setAttribute("book", p);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        int year_published = Integer.parseInt(request.getParameter("year_published"));
        ...
        Book book = new Book(book_id, title, author, year_published, quantity_available, total_quantity, image_url);

        BookDAO bookDAO = new BookDAO();
        boolean isAdded = bookDAO.UpdateBook(book);
